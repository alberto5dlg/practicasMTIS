...
public class Proveedor3Skeleton{
	...
	public org.example.www.proveedor3.ActualizarStockResponse actualizarStock(org.example.www.proveedor3.ActualizarStock actualizarStock)  throws SQLException
    {
	...
	public org.example.www.proveedor3.SolicitarPresupuestoResponse solicitarPresupuesto(org.example.www.proveedor3.SolicitarPresupuesto solicitarPresupuesto) throws SQLException
    {
	...
	public org.example.www.proveedor3.OrdenarCompraResponse ordenarCompra(org.example.www.proveedor3.OrdenarCompra ordenarCompra) throws SQLException
    {
