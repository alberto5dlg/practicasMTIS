        ...
        */
        ...
        if((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils.xmlNameToJavaIdentifier(op.getName().getLocalPart())) != null)){
            ...
            if("solicitarPresupuesto".equals(methodName)){
                ...
                org.example.www.proveedor1.SolicitarPresupuestoResponse solicitarPresupuestoResponse13 = null;
	                        org.example.www.proveedor1.SolicitarPresupuesto wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), solicitarPresupuestoResponse13, false, new javax.xml.namespace.QName("http://www.example.org/proveedor1/",
                                                    "solicitarPresupuesto"));
                                    } else 

            if("actualizarStock".equals(methodName)){
                
                org.example.www.proveedor1.ActualizarStockResponse actualizarStockResponse15 = null;
	                        org.example.www.proveedor1.ActualizarStock wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), actualizarStockResponse15, false, new javax.xml.namespace.QName("http://www.example.org/proveedor1/",
                                                    "actualizarStock"));
                                    } else 

            if("ordenarCompra".equals(methodName)){
                
                org.example.www.proveedor1.OrdenarCompraResponse ordenarCompraResponse17 = null;
	                        org.example.www.proveedor1.OrdenarCompra wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), ordenarCompraResponse17, false, new javax.xml.namespace.QName("http://www.example.org/proveedor1/",
                                                    "ordenarCompra"));
