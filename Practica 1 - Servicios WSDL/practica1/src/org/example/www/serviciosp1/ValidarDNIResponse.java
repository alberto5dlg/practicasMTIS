 ...
 */
            ...
            /**
            *  ValidarDNIResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ValidarDNIResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":validarDNIResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "validarDNIResponse",
    ...
    public static class Factory{
        ...
        */
        public static ValidarDNIResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ValidarDNIResponse object =
                new ValidarDNIResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"validarDNIResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ValidarDNIResponse)org.example.www.serviciosp1.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
