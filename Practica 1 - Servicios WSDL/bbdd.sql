...
INSERT INTO `COLUMNS` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `COLUMN_NAME`, `ORDINAL_POSITION`, `COLUMN_DEFAULT`, `IS_NULLABLE`, `DATA_TYPE`, `CHARACTER_MAXIMUM_LENGTH`, `CHARACTER_OCTET_LENGTH`, `NUMERIC_PRECISION`, `NUMERIC_SCALE`, `CHARACTER_SET_NAME`, `COLLATION_NAME`, `COLUMN_TYPE`, `COLUMN_KEY`, `EXTRA`, `PRIVILEGES`, `COLUMN_COMMENT`) VALUES
	...
	(NULL, 'practica1', 'codigopostal', 'provincia', 1, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
	(NULL, 'practica1', 'codigopostal', 'poblacion', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
	(NULL, 'practica1', 'codigopostal', 'codigoPostal', 3, NULL, 'NO', 'varchar', 5, 5, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(5)', 'PRI', '', 'select,insert,update,references', ''),
	(NULL, 'practica1', 'presupuestos', 'idPresupuesto', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
	(NULL, 'practica1', 'presupuestos', 'idCliente', 2, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11) unsigned zerofill', '', '', 'select,insert,update,references', ''),
	(NULL, 'practica1', 'presupuestos', 'refProducto', 3, NULL, 'YES', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
	(NULL, 'practica1', 'presupuestos', 'cantidadProd', 4, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
	(NULL, 'practica1', 'presupuestos', 'fechaPresupuesto', 5, NULL, 'YES', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
	(NULL, 'practica1', 'producto', 'refPieza', 1, '0', 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', 'PRI', '', 'select,insert,update,references', ''),
	(NULL, 'practica1', 'producto', 'idProveedor', 2, '0', 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', 'PRI', '', 'select,insert,update,references', ''),
	(NULL, 'practica1', 'producto', 'fechaPieza', 3, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
	(NULL, 'practica1', 'producto', 'precio', 4, NULL, 'NO', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
	(NULL, 'practica1', 'producto', 'cantidad', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
	(NULL, 'practica1', 'soapkey', 'key', 1, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', 'PRI', '', 'select,insert,update,references', '');
...
INSERT INTO `KEY_COLUMN_USAGE` (`CONSTRAINT_CATALOG`, `CONSTRAINT_SCHEMA`, `CONSTRAINT_NAME`, `TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `COLUMN_NAME`, `ORDINAL_POSITION`, `POSITION_IN_UNIQUE_CONSTRAINT`, `REFERENCED_TABLE_SCHEMA`, `REFERENCED_TABLE_NAME`, `REFERENCED_COLUMN_NAME`) VALUES
	...
	(NULL, 'practica1', 'PRIMARY', NULL, 'practica1', 'codigopostal', 'codigoPostal', 1, NULL, NULL, NULL, NULL),
	(NULL, 'practica1', 'PRIMARY', NULL, 'practica1', 'presupuestos', 'idPresupuesto', 1, NULL, NULL, NULL, NULL),
	(NULL, 'practica1', 'PRIMARY', NULL, 'practica1', 'producto', 'refPieza', 1, NULL, NULL, NULL, NULL),
	(NULL, 'practica1', 'PRIMARY', NULL, 'practica1', 'producto', 'idProveedor', 2, NULL, NULL, NULL, NULL),
	(NULL, 'practica1', 'PRIMARY', NULL, 'practica1', 'soapkey', 'key', 1, NULL, NULL, NULL, NULL);
...
INSERT INTO `SCHEMATA` (`CATALOG_NAME`, `SCHEMA_NAME`, `DEFAULT_CHARACTER_SET_NAME`, `DEFAULT_COLLATION_NAME`, `SQL_PATH`) VALUES
	...
	(NULL, 'practica1', 'latin1', 'latin1_swedish_ci', NULL);
...
INSERT INTO `STATISTICS` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `NON_UNIQUE`, `INDEX_SCHEMA`, `INDEX_NAME`, `SEQ_IN_INDEX`, `COLUMN_NAME`, `COLLATION`, `CARDINALITY`, `SUB_PART`, `PACKED`, `NULLABLE`, `INDEX_TYPE`, `COMMENT`) VALUES
	...
	(NULL, 'practica1', 'codigopostal', 0, 'practica1', 'PRIMARY', 1, 'codigoPostal', 'A', 7, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'practica1', 'presupuestos', 0, 'practica1', 'PRIMARY', 1, 'idPresupuesto', 'A', 10, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'practica1', 'producto', 0, 'practica1', 'PRIMARY', 1, 'refPieza', 'A', NULL, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'practica1', 'producto', 0, 'practica1', 'PRIMARY', 2, 'idProveedor', 'A', 1, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'practica1', 'soapkey', 0, 'practica1', 'PRIMARY', 1, 'key', 'A', 1, NULL, NULL, '', 'BTREE', '');
...
INSERT INTO `TABLES` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `TABLE_TYPE`, `ENGINE`, `VERSION`, `ROW_FORMAT`, `TABLE_ROWS`, `AVG_ROW_LENGTH`, `DATA_LENGTH`, `MAX_DATA_LENGTH`, `INDEX_LENGTH`, `DATA_FREE`, `AUTO_INCREMENT`, `CREATE_TIME`, `UPDATE_TIME`, `CHECK_TIME`, `TABLE_COLLATION`, `CHECKSUM`, `CREATE_OPTIONS`, `TABLE_COMMENT`) VALUES
	...
	(NULL, 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 0, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-02-20 23:03:17', '2017-02-20 23:03:17', NULL, 'utf8_general_ci', NULL, 'max_rows=8715', ''),
	...
	(NULL, 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 0, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-02-20 23:03:17', '2017-02-20 23:03:17', NULL, 'utf8_general_ci', NULL, 'max_rows=9172', ''),
	...
	(NULL, 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 0, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-02-20 23:03:17', '2017-02-20 23:03:17', NULL, 'utf8_general_ci', NULL, 'max_rows=7652', ''),
	...
	(NULL, 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 0, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-02-20 23:03:17', '2017-02-20 23:03:17', NULL, 'utf8_general_ci', NULL, 'max_rows=15073', ''),
	(NULL, 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 1024, 0, NULL, '2008-08-04 14:32:22', '2008-08-04 14:32:22', NULL, 'utf8_bin', NULL, '', 'Column privileges'),
	(NULL, 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 876, 123286039799267327, 4096, 876, NULL, '2008-08-04 14:32:22', '2008-09-13 12:40:58', '2008-08-04 14:32:23', 'utf8_bin', NULL, '', 'Database privileges'),
	(NULL, 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2008-08-04 14:32:22', '2008-08-04 14:32:22', NULL, 'utf8_bin', NULL, '', 'User defined functions'),
	(NULL, 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 38, 581, 22078, 163536961468891135, 3072, 0, NULL, '2008-08-04 14:32:22', '2008-08-04 14:32:24', NULL, 'utf8_general_ci', NULL, '', 'help categories'),
	(NULL, 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 404, 197, 79588, 55450570411999231, 14336, 0, NULL, '2008-08-04 14:32:23', '2008-08-04 14:32:24', NULL, 'utf8_general_ci', NULL, '', 'help keywords'),
	(NULL, 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 841, 9, 7569, 2533274790395903, 16384, 0, NULL, '2008-08-04 14:32:22', '2008-08-04 14:32:24', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
	(NULL, 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 479, 761, 364580, 281474976710655, 17408, 0, NULL, '2008-08-04 14:32:22', '2008-08-04 14:32:24', NULL, 'utf8_general_ci', NULL, '', 'help topics'),
	(NULL, 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 109775240917155839, 1024, 0, NULL, '2008-08-04 14:32:22', '2008-08-04 14:32:22', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
	(NULL, 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2008-08-04 14:32:23', '2008-08-04 14:32:24', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
	(NULL, 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 1024, 0, NULL, '2008-08-04 14:32:23', '2008-08-04 14:32:24', NULL, 'utf8_bin', NULL, '', 'Procedure privileges'),
	(NULL, 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 1024, 0, NULL, '2008-08-04 14:32:22', '2008-08-04 14:32:22', NULL, 'utf8_bin', NULL, '', 'Table privileges'),
	(NULL, 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2008-08-04 14:32:23', '2008-08-04 14:32:24', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
	(NULL, 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2008-08-04 14:32:23', '2008-08-04 14:32:24', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
	(NULL, 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2008-08-04 14:32:23', '2008-08-04 14:32:24', NULL, 'utf8_general_ci', NULL, '', 'Time zone names'),
	(NULL, 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2008-08-04 14:32:23', '2008-08-04 14:32:24', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
	(NULL, 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2008-08-04 14:32:23', '2008-08-04 14:32:24', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
	(NULL, 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 98, 196, 281474976710655, 2048, 0, NULL, '2008-08-04 14:32:22', '2008-09-13 12:54:32', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
	(NULL, 'practica1', 'codigopostal', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 7, 28, 200, 281474976710655, 2048, 0, NULL, '2017-02-14 12:05:26', '2017-02-15 10:34:44', NULL, 'latin1_swedish_ci', NULL, '', ''),
	(NULL, 'practica1', 'presupuestos', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 10, 27, 272, 281474976710655, 2048, 0, 11, '2017-02-15 17:10:57', '2017-02-16 21:12:34', NULL, 'latin1_swedish_ci', NULL, '', ''),
	(NULL, 'practica1', 'producto', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 24, 24, 281474976710655, 2048, 0, NULL, '2017-02-15 12:33:32', '2017-02-15 13:19:47', NULL, 'latin1_swedish_ci', NULL, '', ''),
	(NULL, 'practica1', 'soapkey', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 20, 20, 281474976710655, 2048, 0, NULL, '2017-02-15 09:09:28', '2017-02-15 09:09:28', NULL, 'latin1_swedish_ci', NULL, '', '');
...
INSERT INTO `TABLE_CONSTRAINTS` (`CONSTRAINT_CATALOG`, `CONSTRAINT_SCHEMA`, `CONSTRAINT_NAME`, `TABLE_SCHEMA`, `TABLE_NAME`, `CONSTRAINT_TYPE`) VALUES
	...
	(NULL, 'practica1', 'PRIMARY', 'practica1', 'codigopostal', 'PRIMARY KEY'),
	(NULL, 'practica1', 'PRIMARY', 'practica1', 'presupuestos', 'PRIMARY KEY'),
	(NULL, 'practica1', 'PRIMARY', 'practica1', 'producto', 'PRIMARY KEY'),
	(NULL, 'practica1', 'PRIMARY', 'practica1', 'soapkey', 'PRIMARY KEY');
...
-- Volcando datos para la tabla mysql.db: 0 rows
...
INSERT INTO `help_category` (`help_category_id`, `name`, `parent_category_id`, `url`) VALUES
	...
	(9, 'Point properties', 32, ''),
	(10, 'Encryption Functions', 36, ''),
	(11, 'LineString properties', 32, ''),
	(12, 'Logical operators', 36, ''),
	(13, 'Miscellaneous Functions', 36, ''),
	(14, 'Information Functions', 36, ''),
	(15, 'Functions and Modifiers for Use with GROUP BY', 33, ''),
	(16, 'Storage Engines', 33, ''),
	...
	(27, 'Utility', 33, ''),
	(28, 'Geometry relations', 32, ''),
	(29, 'Language Structure', 33, ''),
	...
	(36, 'Functions', 33, ''),
	(37, 'Stored Routines', 33, ''),
	(38, 'Data Definition', 33, '');
...
-- Volcando datos para la tabla mysql.help_keyword: 404 rows
...
INSERT INTO `help_keyword` (`help_keyword_id`, `name`) VALUES
	...
	(197, 'INDEX'),
	(198, 'DUAL'),
	(199, 'MULTIPOINTFROMTEXT'),
	(200, 'BACKUP'),
	(201, 'MULTILINESTRINGFROMWKB'),
	(202, 'EXTENDED'),
	(203, 'CROSS'),
	(204, 'NATIONAL'),
	(205, 'GROUP'),
...
-- Volcando datos para la tabla mysql.help_relation: 841 rows
...
-- Volcando datos para la tabla mysql.help_topic: 479 rows
...
-- Volcando datos para la tabla mysql.user: 2 rows
/*!40000 ALTER TABLE `user` DISABLE KEYS */;
INSERT INTO `user` (`Host`, `User`, `Password`, `Select_priv`, `Insert_priv`, `Update_priv`, `Delete_priv`, `Create_priv`, `Drop_priv`, `Reload_priv`, `Shutdown_priv`, `Process_priv`, `File_priv`, `Grant_priv`, `References_priv`, `Index_priv`, `Alter_priv`, `Show_db_priv`, `Super_priv`, `Create_tmp_table_priv`, `Lock_tables_priv`, `Execute_priv`, `Repl_slave_priv`, `Repl_client_priv`, `Create_view_priv`, `Show_view_priv`, `Create_routine_priv`, `Alter_routine_priv`, `Create_user_priv`, `ssl_type`, `ssl_cipher`, `x509_issuer`, `x509_subject`, `max_questions`, `max_updates`, `max_connections`, `max_user_connections`) VALUES
	('localhost', 'root', '*81F5E21E35407D884A6CD4A731AEBFB6AF209E1B', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', _binary '', _binary '', _binary '', 0, 0, 0, 0),
	('127.0.0.1', 'root', '*81F5E21E35407D884A6CD4A731AEBFB6AF209E1B', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', _binary '', _binary '', _binary '', 0, 0, 0, 0);
/*!40000 ALTER TABLE `user` ENABLE KEYS */;


-- Volcando estructura de base de datos para practica1
CREATE DATABASE IF NOT EXISTS `practica1` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `practica1`;

-- Volcando estructura para tabla practica1.codigopostal
...
-- Volcando datos para la tabla practica1.codigopostal: 7 rows
/*!40000 ALTER TABLE `codigopostal` DISABLE KEYS */;
INSERT INTO `codigopostal` (`provincia`, `poblacion`, `codigoPostal`) VALUES
	('Alicante', 'Benidorm', '03500'),
	('Alicante', 'La Nucia', '03530'),
	('Alicante', 'Finestrat', '03509'),
	('Alicante', 'Gran Alacant', '03130'),
	('Alicante ', 'Alicante', '03080'),
	('Valencia', 'Alboraya', '46120'),
	('Valencia', 'Valencia', '46080');
/*!40000 ALTER TABLE `codigopostal` ENABLE KEYS */;

-- Volcando estructura para tabla practica1.presupuestos
CREATE TABLE IF NOT EXISTS `presupuestos` (
  `idPresupuesto` int(11) NOT NULL auto_increment,
  `idCliente` int(11) unsigned zerofill default NULL,
  `refProducto` varchar(50) default NULL,
  `cantidadProd` int(11) default NULL,
  `fechaPresupuesto` date default NULL,
  PRIMARY KEY  (`idPresupuesto`)
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla practica1.presupuestos: 10 rows
/*!40000 ALTER TABLE `presupuestos` DISABLE KEYS */;
INSERT INTO `presupuestos` (`idPresupuesto`, `idCliente`, `refProducto`, `cantidadProd`, `fechaPresupuesto`) VALUES
	(1, 00000000001, '1hwh', 2, '0000-00-00'),
	(2, 00000000001, '1hwh', 2, '0000-00-00'),
	(3, 00000000001, '1hwh', 2, '2017-03-12'),
	(4, 00000000001, '13wh', 2, '2017-03-12'),
	(5, 00000000012, '1df56', 2, '2017-03-12'),
	(6, 00000112352, '1q2w3e', 3, '2017-02-25'),
	(7, 00000056238, '7t6e8i', 10, '2017-02-27'),
	(8, 00000076638, '2g6x8k', 7, '2017-02-26'),
	(9, 00000007439, '7g9k1a', 8, '2017-03-29'),
	(10, 00000004761, '63gf34f', 12, '2017-02-25');
/*!40000 ALTER TABLE `presupuestos` ENABLE KEYS */;

-- Volcando estructura para tabla practica1.producto
CREATE TABLE IF NOT EXISTS `producto` (
  `refPieza` varchar(50) NOT NULL default '0',
  `idProveedor` varchar(50) NOT NULL default '0',
  `fechaPieza` date NOT NULL,
  `precio` float NOT NULL,
  `cantidad` int(11) NOT NULL,
  PRIMARY KEY  (`refPieza`,`idProveedor`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla practica1.producto: 1 rows
/*!40000 ALTER TABLE `producto` DISABLE KEYS */;
INSERT INTO `producto` (`refPieza`, `idProveedor`, `fechaPieza`, `precio`, `cantidad`) VALUES
	('1', '0011', '2017-02-15', 25.5, 10);
/*!40000 ALTER TABLE `producto` ENABLE KEYS */;

-- Volcando estructura para tabla practica1.soapkey
CREATE TABLE IF NOT EXISTS `soapkey` (
  `key` varchar(50) NOT NULL,
  PRIMARY KEY  (`key`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla practica1.soapkey: 1 rows
/*!40000 ALTER TABLE `soapkey` DISABLE KEYS */;
INSERT INTO `soapkey` (`key`) VALUES
	('123456');
